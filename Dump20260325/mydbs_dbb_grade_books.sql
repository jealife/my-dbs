...
--
-- Table structure for table `grade_books`
--
...
CREATE TABLE `grade_books` (
  ...
  `teacher_appreciation` varchar(1000) DEFAULT NULL,
  `validated` bit(1) NOT NULL,
  `weighted_average` double DEFAULT NULL,
  `academic_year_id` bigint NOT NULL,
  `cohort_id` bigint DEFAULT NULL,
  `course_id` bigint NOT NULL,
  `student_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_gradebook_student_course_year` (`student_id`,`course_id`,`academic_year_id`),
  KEY `idx_gradebook_student` (`student_id`),
  KEY `idx_gradebook_course` (`course_id`),
  KEY `idx_gradebook_year` (`academic_year_id`),
  KEY `fk_gradebook_cohort` (`cohort_id`),
...
-- Dump completed on 2026-03-25 11:27:28
