...
CREATE TABLE `grade_items` (
  ...
  `item_type` enum('ASSIGNMENT','EVALUATION','MANUAL','PARTICIPATION','QUIZ') NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_gradeitem_gradebook` (`grade_book_id`),
  KEY `idx_gradeitem_type` (`item_type`),
  KEY `idx_gradeitem_source` (`source_id`),
...
-- Dump completed on 2026-03-25 11:27:24
