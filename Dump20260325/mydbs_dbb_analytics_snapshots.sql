...
CREATE TABLE `analytics_snapshots` (
  ...
  `cohort_rank` int DEFAULT NULL,
  `dropout_risk_score` decimal(5,2) DEFAULT NULL,
  `ects_earned` int DEFAULT NULL,
  `late_submissions_count` int DEFAULT NULL,
  `program_id` bigint DEFAULT NULL,
  `scope` varchar(20) NOT NULL,
  `student_id` bigint DEFAULT NULL,
  `unjustified_absences_count` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_snapshot_student` (`student_id`),
  KEY `idx_snapshot_cohort` (`cohort_id`),
  KEY `idx_snapshot_year` (`academic_year_id`),
  KEY `idx_snapshot_scope` (`scope`)
