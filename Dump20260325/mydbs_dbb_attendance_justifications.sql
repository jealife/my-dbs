...
--
-- Table structure for table `attendance_justifications`
--

DROP TABLE IF EXISTS `attendance_justifications`;
...
CREATE TABLE `attendance_justifications` (
  ...
  `reviewer_comment` varchar(1000) DEFAULT NULL,
  `status` enum('APPROVED','PENDING','REJECTED') NOT NULL,
  `attendance_record_id` bigint DEFAULT NULL,
  `student_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_justif_student` (`student_id`),
  KEY `idx_justif_status` (`status`),
  KEY `idx_justif_dates` (`absence_date_from`),
  KEY `fk_justif_record` (`attendance_record_id`),
...
-- Dump completed on 2026-03-25 11:27:37
