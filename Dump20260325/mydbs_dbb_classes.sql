...
CREATE TABLE `classes` (
  ...
  `status` enum('ACTIVE','ARCHIVED','CLOSED','PLANNED','SUSPENDED') NOT NULL,
  ...
  KEY `fk_class_academic_year` (`academic_year_id`),
  KEY `fk_class_cohort` (`cohort_id`),
  KEY `fk_class_program` (`program_id`),
