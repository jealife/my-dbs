...
CREATE TABLE `rubric_criteria` (
  ...
  `weight_percentage` double NOT NULL,
  `evaluation_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_rubric_evaluation` (`evaluation_id`),
  CONSTRAINT `fk_rubric_evaluation` FOREIGN KEY (`evaluation_id`) REFERENCES `evaluations` (`id`)
