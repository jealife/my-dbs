...
CREATE TABLE `student_status_history` (
  ...
  `new_status` enum('ACTIVE','ADMITTED','APPLIED','ARCHIVED','DROPPED_OUT','GRADUATED','SUSPENDED') NOT NULL,
  `old_status` enum('ACTIVE','ADMITTED','APPLIED','ARCHIVED','DROPPED_OUT','GRADUATED','SUSPENDED') DEFAULT NULL,
  `reason` varchar(2000) DEFAULT NULL,
  `student_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_student_status_history_student` (`student_id`),
